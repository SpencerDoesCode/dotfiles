...
syn keyword jManipulation   contained append appendTo html preprend prependTo text debug log
...
syn keyword eCLSt			eCarList console App Admin Backend Util
syn keyword eCLId			hidden init type url data success error 
...
if version >= 508 || !exists("did_lisp_syntax_inits")
  ...
  hi def link eCLSt		Statement
  hi def link eCLId		Identifier
