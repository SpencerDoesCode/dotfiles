...
badd +4530 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +676 code/lib/eCarList/BLL/CRUD/Settings/UserSettings.pm
badd +0 code/lib/eCarList/BLL/CRUD/UserNotification.pm
badd +0 code/lib/eCarList/DM/Mongo/UserNotification.pm
args code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowValues.js
edit code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowValues.js
...
silent! normal! zE
let s:l = 308 - ((54 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2123 - ((0 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2123
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4489 - ((31 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4489
normal! 02l
tabedit code/lib/eCarList/BLL/CRUD/UserNotification.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 134 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
134
normal! 04l
tabedit code/lib/eCarList/DM/Mongo/UserNotification.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
