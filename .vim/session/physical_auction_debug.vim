...
set shortmess=aoO
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
badd +1 templates/admin/search/physical_search_results.tmpl
badd +0 templates/admin/search/physical_search.tmpl
badd +0 code/bots/physicalauctionbot/script/load_adesa.pl
badd +0 code/lib/eCarList/App/Bot/PhysicalAuctionImport.pm
badd +4453 code/lib/eCarList/BLL/Auction.pm
badd +0 code/lib/eCarList/BLL/CRUD/PhysicalAuction.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
set stal=2
...
silent! normal! zE
let s:l = 553 - ((55 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
553
normal! 09|
tabedit code/bots/physicalauctionbot/script/load_adesa.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 159 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
159
normal! 0
tabedit code/lib/eCarList/App/Bot/PhysicalAuctionImport.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 179 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
179
normal! 09|
tabedit code/lib/eCarList/BLL/CRUD/PhysicalAuction.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 519 - ((0 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
519
normal! 05|
tabedit templates/admin/search/physical_search.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
