...
set shortmess=aoO
badd +42 code/lib/eCarList/DM/KARD/Vehicle.pm
badd +1 code/lib/eCarList/Bridge/Chrome/ADS7/Request/VehicleDescriptionRequest.pm
badd +1 code/lib/eCarList/Bridge/Chrome/ADS7/Request.pm
badd +1 code/lib/eCarList/Bridge/Chrome/ADS7.pm
badd +0 code/lib/eCarList/DM/Memcached.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
badd +0 code/lib/eCarList/BLL/CRUD/Vehicle.pm
badd +0 code/lib/eCarList/DM/CacheConsumer/VehicleAttributes.pm
badd +0 code/lib/eCarList/DM/CacheConsumer/_CacheConsumer.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/DM/KARD/Vehicle.pm
set stal=2
edit code/lib/eCarList/DM/KARD/Vehicle.pm
...
silent! normal! zE
let s:l = 1225 - ((30 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1225
normal! 082|
tabedit code/lib/eCarList/DM/Memcached.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((43 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
normal! 0
tabedit code/lib/eCarList/Bridge/Chrome/ADS7/Request/VehicleDescriptionRequest.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((65 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
normal! 09|
tabedit code/lib/eCarList/Bridge/Chrome/ADS7/Request.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 177 - ((37 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
normal! 041|
tabedit code/lib/eCarList/Bridge/Chrome/ADS7.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
