...
set shortmess=aoO
badd +0 code/lib/eCarList/DM/KARD/Vehicle.pm
badd +0 code/bots/chromebot/script/load_engines.pl
badd +0 code/lib/eCarList/Bridge/Chrome/ADS7/Utils.pm
badd +0 code/lib/eCarList/Bridge/Chrome/ADS7/Request/VehicleDescriptionRequest.pm
badd +0 code/lib/eCarList/Bridge/Chrome/ADS7/Request.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/DM/KARD/Vehicle.pm
set stal=2
edit code/bots/chromebot/script/load_engines.pl
...
silent! normal! zE
let s:l = 110 - ((51 * winheight(0) + 41) / 83)
...
1
normal! 0
tabedit code/lib/eCarList/Bridge/Chrome/ADS7/Utils.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((78 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
