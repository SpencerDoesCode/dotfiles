...
badd +0 templates/admin/search/search.tmpl
badd +37 code/lib/eCarList/DM/KARD/User.pm
args code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
...
silent! normal! zE
let s:l = 665 - ((62 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 120 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
