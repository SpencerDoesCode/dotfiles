...
badd +0 code/test/eCarListTest/BLL/CRUD/Transfer.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/CRUD/Transfer.pm
set stal=2
...
silent! normal! zE
let s:l = 857 - ((35 * winheight(0) + 28) / 56)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 351 - ((35 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
351
normal! 09|
tabedit code/test/eCarListTest/BLL/CRUD/Transfer.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 435 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
435
