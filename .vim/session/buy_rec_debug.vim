...
badd +1 templates/admin/market_buyer_recommendations_vehicles.tmpl
...
set stal=2
edit code/lib/javascript/eCarList/App/Admin/MarketBuyerPage.js
...
silent! normal! zE
let s:l = 634 - ((51 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 407 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
407
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1150 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1150
