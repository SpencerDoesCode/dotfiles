...
set shortmess=aoO
badd +518 templates/admin/appraisal/workflow_values.tmpl
badd +0 templates/admin/appraisal/recommendation.tmpl
...
argglobal
silent! argdel *
argadd templates/admin/appraisal/workflow_values.tmpl
set stal=2
edit templates/admin/appraisal/recommendation.tmpl
...
silent! normal! zE
let s:l = 79 - ((55 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
normal! 021|
tabedit code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowValues.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 601 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
601
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2888 - ((28 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2888
