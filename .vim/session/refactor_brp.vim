...
set shortmess=aoO
badd +1402 code/lib/eCarList/BLL/CRUD/Market.pm
badd +0 code/lib/eCarList/BLL/CRUD/VinStyle.pm
badd +0 code/test/eCarListTest/BLL/CRUD/VinStyle.pm
badd +0 code/test/eCarListTest/BLL/AutoInk.pm
badd +0 code/lib/eCarList/BLL/CRUD/Search/AuctionSearch.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Wishlist.pm
badd +0 code/lib/eCarList/DM/KARD.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/WebService/Auction.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/CRUD/Market.pm
set stal=2
edit code/lib/eCarList/BLL/CRUD/Market.pm
...
silent! normal! zE
let s:l = 651 - ((73 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 232 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
232
...
exe 'vert 1resize ' . ((&columns * 135 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 136 + 136) / 272)
tabedit code/lib/eCarList/App/Interfaces/Web/WebService/Auction.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 186 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
normal! 017|
tabedit code/lib/eCarList/BLL/CRUD/VinStyle.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 583 - ((37 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
583
normal! 018|
tabedit code/lib/eCarList/DM/KARD.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 666 - ((52 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
666
normal! 048|
tabedit code/test/eCarListTest/BLL/CRUD/VinStyle.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((60 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
