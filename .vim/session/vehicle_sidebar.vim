...
set shortmess=aoO
badd +1 code/lib/javascript/eCarList/App/Analytics/Sidebar.js
badd +6970 assets/admin/js/analytics/appraisal.js
badd +1 code/lib/eCarList/App/Interfaces/Web/WebService/Vehicle.pm
badd +1 code/lib/eCarList/BLL/BREAD/Vehicle.pm
badd +1 templates/admin/search/search_vehicle_detail.tmpl
badd +0 code/lib/javascript/eCarList/App/Analytics/Sidebar/IdealInventory.js
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/IdealInventory.pm
badd +0 templates/admin/hd/ui_panel.tmpl
argglobal
silent! argdel *
argadd code/lib/javascript/eCarList/App/Analytics/Sidebar.js
set stal=2
edit code/lib/javascript/eCarList/App/Analytics/Sidebar.js
...
silent! normal! zE
let s:l = 74 - ((22 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
normal! 040|
tabedit code/lib/javascript/eCarList/App/Analytics/Sidebar/IdealInventory.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 117 - ((49 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
normal! 044|
tabedit code/lib/eCarList/App/Interfaces/Web/Admin/IdealInventory.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 204 - ((37 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
normal! 02|
tabedit code/lib/eCarList/App/Interfaces/Web/WebService/Vehicle.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 931 - ((33 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
931
normal! 05|
tabedit code/lib/eCarList/BLL/BREAD/Vehicle.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 125 - ((25 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
