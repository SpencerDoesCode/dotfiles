...
badd +0 templates/backend/qa/auction.tmpl
args code/lib/javascript/eCarList/App/Backend/QA/Mobile.js
edit code/lib/javascript/eCarList/App/Backend/QA/Mobile.js
...
silent! normal! zE
let s:l = 186 - ((0 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 845 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
845
normal! 0
tabedit templates/backend/qa/auction.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
