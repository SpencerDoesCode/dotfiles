...
silent only
cd ~/repos/ecl~/repos/ecl~/repos/ecl_tag
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 templates/backend/features/appraisal_workflow.tmpl
badd +1 code/lib/css/eCarList/backend/_features.scss
badd +386 code/lib/javascript/eCarList/App/Backend/FeaturesPage.js
badd +1 code/lib/eCarList/App/Interfaces/Web/Backend/Features.pm
badd +2616 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +42 templates/admin/appraisal/workflow_values.tmpl
badd +1 templates/admin/appraisal/recommendation.tmpl
badd +1 code/lib/css/eCarList/admin/_appraisal_values.scss
badd +1 code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowValues.js
badd +26 code/lib/eCarList/BLL/CRUD/AppraisalCentral.pm
badd +1 code/test/eCarListTest/BLL/CRUD/AppraisalCentral.pm
badd +1 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +177 templates/admin/analytics/appraisal_report.tmpl
badd +1 templates/admin/appraisal/appraisal_list_table.tmpl
badd +1 code/lib/eCarList/BLL/CRUD/Settings/DealerSetting.pm
badd +0 templates/admin/appraisal/recommendation_status.tmpl
argglobal
silent! argdel *
argadd templates/backend/features/appraisal_workflow.tmpl
set stal=2
edit templates/backend/features/appraisal_workflow.tmpl
...
silent! normal! zE
let s:l = 81 - ((68 * winheight(0) + 37) / 75)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4282 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4282
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 459 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
459
normal! 0
tabedit templates/admin/appraisal/recommendation.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((34 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
normal! 029|
tabedit templates/admin/appraisal/workflow_values.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((44 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
normal! 024|
tabedit code/lib/eCarList/BLL/CRUD/Settings/DealerSetting.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 757 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
757
normal! 015|
tabedit code/test/eCarListTest/BLL/CRUD/AppraisalCentral.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
32
normal! 0
tabedit templates/admin/appraisal/appraisal_list_table.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 301 - ((40 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
301
