...
set shortmess=aoO
badd +0 templates/admin/inventory/common_cr.tmpl
...
args templates/admin/inventory/common_cr.tmpl
edit templates/admin/inventory/common_cr.tmpl
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((68 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 549 - ((18 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
549
