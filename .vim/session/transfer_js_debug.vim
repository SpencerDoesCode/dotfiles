...
set shortmess=aoO
badd +0 templates/admin/transfer/details.tmpl
badd +0 code/lib/javascript/eCarList/App/Analytics/Sidebar/IdealInventory.js
badd +204 code/lib/eCarList/App/Interfaces/Web/Admin/IdealInventory.pm
badd +41 templates/admin/hd/ui_panel.tmpl
badd +0 templates/admin/transfer/truetarget.tmpl
args templates/admin/transfer/details.tmpl
edit templates/admin/transfer/details.tmpl
...
silent! normal! zE
let s:l = 139 - ((55 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
normal! 0
tabedit templates/admin/transfer/truetarget.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 83 - ((0 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
