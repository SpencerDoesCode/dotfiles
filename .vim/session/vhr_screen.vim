...
set shortmess=aoO
badd +1 ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Carfax.pm
badd +0 ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
badd +0 ecl/templates/admin/analytics_sidebar.tmpl
badd +0 ecl/templates/admin/carfax_widget.tmpl
badd +0 ecl/templates/oadmin/analytics_sidebar.tmpl
argglobal
silent! argdel *
argadd ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Carfax.pm
argadd ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
argadd ecl/templates/admin/analytics_sidebar.tmpl
argadd ecl/templates/admin/carfax_widget.tmpl
argadd ecl/templates/oadmin/analytics_sidebar.tmpl
set stal=2
edit ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Carfax.pm
...
1
normal! 0
tabedit ecl/code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2645 - ((43 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2645
normal! 05|
tabedit ecl/templates/admin/analytics_sidebar.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((64 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
normal! 060|
tabedit ecl/templates/admin/carfax_widget.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((23 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
normal! 0
tabedit ecl/templates/oadmin/analytics_sidebar.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
