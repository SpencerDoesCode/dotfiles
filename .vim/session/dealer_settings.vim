...
set shortmess=aoO
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Dealer.pm
badd +1 templates/admin/dealer_edit.tmpl
badd +1 code/lib/eCarList/DM/KARD/User.pm
badd +0 code/lib/eCarList/BLL/CRUD/Settings/DealerSetting.pm
badd +1 code/lib/eCarList/BLL/BREAD/BookType.pm
badd +210 code/lib/eCarList/BLL/BREAD/AUTOGEN/BookType.pm
badd +0 code/lib/eCarList/DM/KARD/BookType.pm
badd +65 code/lib/eCarList/DM/KARD/AUTOGEN/BookType.pm
badd +0 code/lib/eCarList/BLL/CRUD/NADA.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/Admin/Dealer.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/Admin/Dealer.pm
...
silent! normal! zE
let s:l = 744 - ((65 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
744
normal! 059|
tabedit code/lib/eCarList/BLL/CRUD/NADA.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
1
normal! 0
tabedit templates/admin/dealer_edit.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 194 - ((49 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
194
