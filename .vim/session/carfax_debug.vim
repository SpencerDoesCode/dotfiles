...
set shortmess=aoO
badd +1 ~/.vimrc
badd +1 code/lib/javascript/eCarList/App/Admin/Carfax.js
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Carfax.pm
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +1 code/lib/eCarList/BLL/CRUD/Carfax.pm
argglobal
silent! argdel *
set stal=2
edit code/lib/javascript/eCarList/App/Admin/Carfax.js
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 5041 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
5041
normal! 0
tabedit code/lib/eCarList/BLL/CRUD/Carfax.pm
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((47 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
wincmd w
argglobal
edit code/lib/eCarList/BLL/CRUD/Carfax.pm
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1183 - ((40 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1183
...
exe 'vert 1resize ' . ((&columns * 135 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 136 + 136) / 272)
tabedit code/lib/eCarList/App/Interfaces/Web/Admin/Carfax.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 392 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
392
