...
badd +1037 code/lib/eCarList/BLL/CRUD/AppraisalCentral.pm
badd +1 ~/.vimrc
...
badd +1 templates/admin/appraisal/appraisal_list.tmpl
badd +1 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +1 code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalList.js
badd +1 code/lib/css/eCarList/admin/_appraisal_list.scss
badd +1 templates/admin/appraisal/recommendation_status.tmpl
badd +1 code/lib/eCarList/BLL/CRUD/Settings/DealerSetting.pm
badd +75 code/lib/eCarList/DM/KARD/Trade.pm
badd +1 code/lib/eCarList/DM/KARD/AUTOGEN/Trade.pm
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 360 - ((73 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((54 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4483 - ((70 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4483
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1064 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1064
normal! 012|
tabedit code/lib/eCarList/DM/KARD/AUTOGEN/Trade.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 572 - ((40 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
572
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 872 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
872
normal! 0
tabedit code/lib/css/eCarList/admin/_appraisal_list.scss
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((51 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
normal! 0
tabedit code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalList.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 348 - ((38 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
348
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 3541 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3541
normal! 0
tabedit templates/admin/appraisal/appraisal_list.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((11 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
