...
set incsearch
set modelines=0
set runtimepath=~/.vim,~/.vim/bundle/Apprentice,~/.vim/bundle/TagHighlight,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/tcomment_vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-perl,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set smarttab
...
badd +1 code/lib/eCarList/BLL/CRUD/AuctionSearch.pm
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
badd +0 templates/admin/search/search_watchlist.tmpl
badd +1 templates/admin/search/search.tmpl
badd +1 ~/.vimrc
badd +2 templates/admin/search/physical_search.tmpl
badd +0 code/lib/javascript/eCarList/App/Admin/SearchPage.js
badd +0 code/lib/eCarList/BLL/CRUD/_Search.pm
args code/lib/eCarList/BLL/Auction.pm
...
silent! normal! zE
let s:l = 2233 - ((0 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1193 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1193
normal! 0
tabedit code/lib/eCarList/BLL/CRUD/AuctionSearch.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 153 - ((18 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 810 - ((22 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
810
normal! 07l
tabedit code/lib/eCarList/BLL/CRUD/_Search.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 457 - ((50 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
457
normal! 02l
tabedit templates/admin/search/search_watchlist.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 87 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
normal! 040l
tabedit code/lib/javascript/eCarList/App/Admin/SearchPage.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1105 - ((15 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1105
normal! 0
tabedit templates/admin/search/search.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((55 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
