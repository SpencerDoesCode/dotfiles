...
badd +0 templates/admin/auction/summary_page.tmpl
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
...
silent! normal! zE
let s:l = 559 - ((27 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
559
normal! 0
tabedit templates/admin/auction/summary_page.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((40 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
