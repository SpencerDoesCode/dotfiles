...
badd +1697 code/lib/eCarList/BLL/BREAD/Vehicle.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/AdminNavigation.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/Admin/Health.pm
...
silent! normal! zE
let s:l = 175 - ((48 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2231 - ((21 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2231
normal! 095|
tabedit code/lib/eCarList/BLL/CRUD/Health.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
2
normal! 0
tabedit templates/admin/health_index.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 254 - ((44 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
254
