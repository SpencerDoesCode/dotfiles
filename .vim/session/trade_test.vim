...
set shortmess=aoO
badd +0 code/lib/eCarList/App/Interfaces/Web/WebService/V1/Appraisal.pm
badd +0 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +0 code/test/eCarListTest/BLL/CRUD/Trade.pm
badd +0 code/test/Integration/BLL/CRUD/Trade.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/WebService/V1/Appraisal.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/WebService/V1/Appraisal.pm
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((0 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
...
wincmd w
argglobal
edit code/lib/eCarList/BLL/CRUD/Trade.pm
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2951 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2951
...
exe 'vert 1resize ' . ((&columns * 135 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 136 + 136) / 272)
tabedit code/test/eCarListTest/BLL/CRUD/Trade.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 128 - ((68 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
128
normal! 020|
tabedit code/test/Integration/BLL/CRUD/Trade.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((11 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
