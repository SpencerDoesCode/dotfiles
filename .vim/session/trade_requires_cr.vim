...
set shortmess=aoO
badd +0 code/lib/eCarList/App/Interfaces/Web/Backend/Circle.pm
badd +0 templates/backend/circle_index.tmpl
badd +0 code/lib/javascript/eCarList/App/Backend/CirclePage.js
badd +65 code/lib/css/eCarList/backend/_circle.scss
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/Launch.js
badd +0 code/lib/javascript/eCarList/App/Admin/Inventory/AuctionLaunchHelper.js
badd +0 templates/admin/inventory/overlay_launch_auction.tmpl
args code/lib/eCarList/App/Interfaces/Web/Backend/Circle.pm
edit code/lib/eCarList/App/Interfaces/Web/Backend/Circle.pm
...
silent! normal! zE
let s:l = 321 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
321
normal! 0
tabedit templates/backend/circle_index.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 71 - ((66 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
normal! 035l
tabedit code/lib/javascript/eCarList/App/Backend/CirclePage.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 513 - ((65 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
513
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((19 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 132 - ((16 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
