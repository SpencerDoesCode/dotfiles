...
set shortmess=aoO
badd +0 templates/backend/features/grouptrade.tmpl
badd +0 code/lib/css/eCarList/backend/_features.scss
badd +0 code/lib/eCarList/App/Interfaces/Web/Backend/Features.pm
badd +0 code/lib/eCarList/BLL/CRUD/Settings/DealerSetting.pm
badd +0 code/lib/eCarList/BLL/Auction.pm
badd +95 code/lib/javascript/eCarList/UI/AutoComplete.js
badd +0 code/lib/eCarList/BLL/Auction/BidEngineEventHandler.pm
badd +0 code/lib/eCarList/BLL/CRUD/Circle.pm
args templates/backend/features/grouptrade.tmpl
edit templates/backend/features/grouptrade.tmpl
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1386 - ((5 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1386
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 160 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
160
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 248 - ((37 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
248
...
30
normal! 0
tabedit code/lib/css/eCarList/backend/_features.scss
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 319 - ((66 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
319
