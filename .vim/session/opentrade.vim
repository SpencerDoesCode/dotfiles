...
set shortmess=aoO
badd +0 code/lib/eCarList/BLL/Auction/Host/LiquidMotorsOpen.pm
badd +0 code/lib/eCarList/BLL/Auction.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +0 templates/backend/qa/opentrade_liquid_motors.tmpl
badd +0 code/lib/css/eCarList/backend/_qa.scss
args code/lib/eCarList/BLL/Auction/Host/LiquidMotorsOpen.pm
edit code/lib/eCarList/BLL/Auction/Host/LiquidMotorsOpen.pm
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4596 - ((37 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4596
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 936 - ((54 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
936
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((57 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((47 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
