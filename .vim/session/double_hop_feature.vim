...
badd +1 code/lib/eCarList/BLL/CRUD/Settings/DefaultDealerSetting.pm
badd +1 code/lib/javascript/eCarList/App/Backend/FeaturesPage.js
badd +1 templates/backend/features_subtab.tmpl
...
1
normal! 0
tabedit code/lib/javascript/eCarList/App/Backend/FeaturesPage.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 987 - ((53 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
987
...
wincmd w
argglobal
edit code/lib/javascript/eCarList/App/Backend/FeaturesPage.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 275 - ((44 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
275
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 928 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
928
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 695 - ((42 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
695
normal! 078|
tabedit code/lib/eCarList/BLL/CRUD/Settings/DefaultDealerSetting.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 672 - ((49 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
672
normal! 084|
tabedit templates/backend/features_subtab.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
