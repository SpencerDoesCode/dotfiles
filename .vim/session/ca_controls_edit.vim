...
silent only
cd ~/repos/ecl~/repos/ecl~/repos/ecl-git
...
badd +0 code/lib/eCarList/BLL/CRUD/AppraisalCentral.pm
badd +0 templates/admin/appraisal/appraisal_list_table.tmpl
badd +0 code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalList.js
argglobal
silent! argdel *
argadd templates/admin/appraisal/recommendation_status.tmpl
set stal=2
edit templates/admin/appraisal/recommendation_status.tmpl
...
silent! normal! zE
let s:l = 93 - ((61 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 146 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4381 - ((38 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4381
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 545 - ((51 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
545
