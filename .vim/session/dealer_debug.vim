...
badd +0 code/lib/eCarList/BLL/CRUD/Analytic.pm
badd +184 code/lib/eCarList/BLL/DTV/Report.pm
badd +0 code/lib/eCarList/BLL/DTV.pm
badd +0 code/lib/eCarList/DM/KARD/Dealer.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
...
silent! normal! zE
let s:l = 421 - ((0 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
421
normal! 0
tabedit code/lib/eCarList/DM/KARD/Dealer.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 289 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
289
normal! 040|
tabedit code/lib/eCarList/BLL/CRUD/Analytic.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2236 - ((45 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2236
normal! 012|
tabedit code/lib/eCarList/BLL/DTV/Report.pm
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 139 - ((56 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
...
wincmd w
argglobal
edit code/lib/eCarList/BLL/DTV.pm
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 352 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
352
