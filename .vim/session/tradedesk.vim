...
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Tradedesk.pm
badd +0 code/lib/eCarList/BLL/CRUD/UserEvent.pm
...
silent! normal! zE
let s:l = 488 - ((36 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 352 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
352
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 552 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
552
