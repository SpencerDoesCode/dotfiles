...
set shortmess=aoO
badd +0 code/lib/eCarList/DM/KARD/AUTOGEN/Style.pm
badd +0 code/bots/chromebot/script/load_engines.pl
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
badd +0 code/lib/eCarList/BLL/CRUD/Vehicle.pm
badd +0 load_chrome_1.pl
badd +0 code/bots/chromebot/script/load_chrome_2.pl
badd +0 ~/load_engines_orig.pl
badd +0 ~/.vimrc
argglobal
silent! argdel *
argadd code/lib/eCarList/DM/KARD/AUTOGEN/Style.pm
set stal=2
edit code/lib/eCarList/DM/KARD/AUTOGEN/Style.pm
...
silent! normal! zE
let s:l = 119 - ((41 * winheight(0) + 41) / 83)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2350 - ((43 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2350
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 138 - ((71 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
138
normal! 05|
tabedit load_chrome_1.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 530 - ((82 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
530
normal! 0
tabedit code/bots/chromebot/script/load_chrome_2.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 663 - ((70 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
663
normal! 012|
tabedit code/bots/chromebot/script/load_engines.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
