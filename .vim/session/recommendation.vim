...
badd +353 code/lib/javascript/eCarList/App/Backend/QA/Mobile.js
badd +203 templates/backend/qa/mobile.tmpl
badd +21 code/lib/css/eCarList/backend/_qa.scss
...
silent! normal! zE
let s:l = 164 - ((60 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 182 - ((68 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
182
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 727 - ((65 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
727
