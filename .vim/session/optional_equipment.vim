...
set shortmess=aoO
badd +203 code/lib/eCarList/BLL/CRUD/Option.pm
badd +1 assets/admin/js/eCarList_Site_Admin.js
...
badd +1 code/lib/eCarList/DM/KARD/AUTOGEN/StyleOptionalEquipment.pm
badd +1 code/lib/eCarList/BLL/CRUD/Dashboard/ExecutiveSummary.pm
badd +1 code/lib/eCarList/BLL/CRUD/Dashboard/RetailVsWholesale.pm
...
badd +1 code/lib/eCarList/App/Interfaces/Web/Backend/Search.pm
...
silent! normal! zE
let s:l = 172 - ((0 * winheight(0) + 37) / 75)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
