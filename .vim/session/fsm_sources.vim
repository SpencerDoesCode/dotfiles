...
set isfname=@,48-57,/,.,-,_,+,,,#,$,%,~,=,:
set laststatus=2
set runtimepath=~/.vim,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/lightline.vim/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/vim-startify/,~/.vim/plugged/vim-perl/,~/.vim/plugged/vim-javascript/,~/.vim/plugged/ctrlp.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-perl/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
set smartindent
...
set shortmess=aoO
badd +0 Product/MCU/CGI/fsm_sources_report.cgi
badd +0 Product/MCU/ESP/set_fsm_sources_report.pl
badd +0 ~/fsm_sources.pl
badd +0 Product/MCU/ESP/fsm_sources_report.pl
argglobal
silent! argdel *
argadd Product/MCU/CGI/fsm_sources_report.cgi
set stal=2
edit Product/MCU/CGI/fsm_sources_report.cgi
...
setlocal omnifunc=
setlocal path=.,/usr/include,,,/opt/rh/devtoolset-3/root//usr/lib64/perl5/vendor_perl,/opt/rh/devtoolset-3/root/usr/lib/perl5,/opt/rh/devtoolset-3/root//usr/share/perl5/vendor_perl,/usr/local/lib64/perl5,/usr/local/share/perl5,/usr/lib64/perl5/vendor_perl,/usr/share/perl5/vendor_perl,/usr/lib64/perl5,/usr/share/perl5,,
...
1
normal! 0
tabedit Product/MCU/ESP/set_fsm_sources_report.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 41 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
normal! 0
tabedit Product/MCU/ESP/fsm_sources_report.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 80 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
80
