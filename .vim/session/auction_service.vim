...
set incsearch
set modelines=0
set runtimepath=~/.vim,~/.vim/bundle/TagHighlight,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/tcomment_vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-perl,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set smarttab
...
set shortmess=aoO
badd +1 code/lib/eCarList/App/Interfaces/Web/WebService/Auction.pm
badd +0 code/lib/eCarList/BLL/CRUD/Market.pm
badd +0 code/lib/eCarList/BLL/CRUD/Wishlist.pm
args code/lib/eCarList/App/Interfaces/Web/WebService/Auction.pm code/lib/eCarList/BLL/CRUD/Market.pm code/lib/eCarList/BLL/CRUD/Wishlist.pm
edit code/lib/eCarList/App/Interfaces/Web/WebService/Auction.pm
...
silent! normal! zE
let s:l = 200 - ((15 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
200
normal! 040l
tabedit code/lib/eCarList/BLL/CRUD/Wishlist.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 105 - ((41 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1384 - ((39 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1384
