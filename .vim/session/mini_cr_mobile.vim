...
set shortmess=aoO
badd +1 code/lib/eCarList/App/Interfaces/Web/WebService/V1/ConditionReport.pm
badd +1 code/lib/eCarList/BLL/CRUD/ConditionReport/MiniConditionReport.pm
badd +1 code/lib/eCarList/BLL/CRUD/AppraisalLog/MiniConditionReportLog.pm
badd +1 code/test/eCarListTest/BLL/CRUD/AppraisalLog/MiniConditionReportLog.pm
badd +0 code/test/eCarListTest/BLL/CRUD/ConditionReport/MiniConditionReport.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/App/Interfaces/Web/WebService/V1/ConditionReport.pm
set stal=2
edit code/lib/eCarList/App/Interfaces/Web/WebService/V1/ConditionReport.pm
...
22
normal! 0
tabedit code/lib/eCarList/BLL/CRUD/ConditionReport/MiniConditionReport.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
30
normal! 052|
tabedit code/lib/eCarList/BLL/CRUD/AppraisalLog/MiniConditionReportLog.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
normal! 0
tabedit code/test/eCarListTest/BLL/CRUD/AppraisalLog/MiniConditionReportLog.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((23 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
normal! 05|
tabedit code/test/eCarListTest/BLL/CRUD/ConditionReport/MiniConditionReport.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
