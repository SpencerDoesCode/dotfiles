...
set shortmess=aoO
badd +0 Product/MCU/ESP/addpop.pl
badd +0 Product/MCU/CGI/mod_sensor.cgi
argglobal
silent! argdel *
argadd Product/MCU/ESP/addpop.pl
set stal=2
edit Product/MCU/ESP/addpop.pl
...
silent! normal! zE
let s:l = 94 - ((27 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
normal! 010|
tabedit Product/MCU/CGI/mod_sensor.cgi
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 173 - ((48 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
173
