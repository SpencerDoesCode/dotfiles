...
badd +0 ~/.vimrc
badd +0 code/script/console
badd +0 code/lib/eCarList/App/Interfaces/Console.pm
badd +115 code/lib/eCarList/DM/KARD/Trade.pm
args code/lib/eCarList/BLL/CRUD/DealerGroup.pm
edit code/script/console
...
1
normal! 0
tabedit code/lib/eCarList/App/Interfaces/Console.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 276 - ((28 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
276
