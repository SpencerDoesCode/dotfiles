...
set shortmess=aoO
badd +0 code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowCondition.js
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +0 code/lib/eCarList/BLL/CRUD/ConditionReport.pm
badd +0 templates/admin/appraisal/workflow_condition.tmpl
args code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowCondition.js
edit code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowCondition.js
...
98
normal! 0
tabedit templates/admin/appraisal/workflow_condition.tmpl
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1415 - ((0 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1415
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((15 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
