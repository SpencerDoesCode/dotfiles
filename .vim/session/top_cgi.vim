...
set laststatus=2
set runtimepath=~/.vim/plugged/ctrlp.vim,~/.vim,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/lightline.vim/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/vim-startify/,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
set smartindent
...
set shortmess=aoO
badd +0 Product/MCU/CGI/top.cgi
badd +0 Product/MCU/CGI/tope.cgi
badd +0 Product/Shared/ESP/Modules/ESPweb.pm
argglobal
silent! argdel *
argadd Product/MCU/CGI/top.cgi
set stal=2
edit Product/MCU/CGI/top.cgi
...
silent! normal! zE
let s:l = 655 - ((27 * winheight(0) + 26) / 53)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1985 - ((52 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1985
normal! 08|
tabedit Product/MCU/CGI/tope.cgi
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
