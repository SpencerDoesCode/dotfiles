...
set shortmess=aoO
badd +1 code/perl/eCarList/Dealer.pm
badd +7789 code/perl/eCarList/DBLegacy.pm
badd +1 code/lib/eCarList/DM/KARD/Translator/SWORM/Dealer.pm
badd +1787 code/lib/eCarList/BLL/CRUD/Dealer.pm
badd +78 code/lib/eCarList/DM/KARD/DealerGroup.pm
badd +0 code/lib/eCarList/DM/KARD/AUTOGEN/DealerGroup.pm
args code/perl/eCarList/Dealer.pm
edit code/perl/eCarList/Dealer.pm
...
silent! normal! zE
let s:l = 419 - ((25 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
419
normal! 0
tabedit code/perl/eCarList/DBLegacy.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 7801 - ((15 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
7801
normal! 02l
tabedit code/lib/eCarList/DM/KARD/AUTOGEN/DealerGroup.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 83 - ((5 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
normal! 0
tabedit code/lib/eCarList/DM/KARD/Translator/SWORM/Dealer.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((0 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
