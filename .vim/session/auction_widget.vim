...
badd +0 templates/admin/search/search_results.tmpl
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/Widget.js
badd +0 templates/admin/auction_widget/common/views_offers_watchlist.tmpl
...
silent! normal! zE
let s:l = 497 - ((36 * winheight(0) + 36) / 73)
