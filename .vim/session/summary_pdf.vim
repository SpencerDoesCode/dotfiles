...
set shortmess=aoO
badd +1 code/lib/eCarList/BLL/Paperwork/GroupTradeSummary.pm
badd +674 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +2116 code/lib/eCarList/BLL/Auction.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/Paperwork/GroupTradeSummary.pm
set stal=2
edit code/lib/eCarList/BLL/Paperwork/GroupTradeSummary.pm
...
silent! normal! zE
let s:l = 83 - ((61 * winheight(0) + 37) / 74)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 613 - ((60 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
613
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2037 - ((50 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2037
