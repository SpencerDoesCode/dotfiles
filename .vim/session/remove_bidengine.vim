...
set shortmess=aoO
badd +73 code/script/run/feed_diff.pl
badd +0 code/script/repair/oneoff/remove_bidengine_auctions.pl
badd +0 code/lib/eCarList/BLL/Auction.pm
badd +0 code/lib/eCarList/BLL/CRUD/Circle.pm
badd +0 code/script/run/feed_report.pl
badd +493 ~/repos/ecl_1_9/code/lib/eCarList/BLL/Auction.pm
badd +0 ~/repos/ecl_1_9/code/lib/eCarList/BLL/Auction/EclBidEngine.pm
badd +0 code/lib/eCarList/DM/Mongo.pm
args code/script/run/feed_diff.pl
edit code/script/run/feed_report.pl
...
silent! normal! zE
let s:l = 122 - ((11 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
122
normal! 06l
tabedit code/script/repair/oneoff/remove_bidengine_auctions.pl
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
45
normal! 019l
tabedit code/lib/eCarList/DM/Mongo.pm
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 397 - ((28 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
397
normal! 0
tabedit ~/repos/ecl_1_9/code/lib/eCarList/BLL/Auction/EclBidEngine.pm
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4459 - ((28 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4459
