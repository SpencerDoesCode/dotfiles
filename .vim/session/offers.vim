...
badd +16 templates/admin/auction_widget/common/views_offers_watchlist.tmpl
badd +609 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
...
badd +1190 code/lib/eCarList/DM/KARD/User.pm
badd +0 code/script/repair/oneoff/add_offers_to_watchlist.pl
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1438 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1438
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2099 - ((72 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2099
...
1
normal! 0
tabedit code/script/repair/oneoff/add_offers_to_watchlist.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
