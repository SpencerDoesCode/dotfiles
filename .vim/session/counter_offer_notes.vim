...
set shortmess=aoO
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/OffersModal.js
badd +0 templates/admin/auction_offers_overlay.tmpl
badd +0 code/lib/css/eCarList/admin/_auction_widget.scss
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +24 code/lib/eCarList/App/Bot/_Bot.pm
badd +0 code/lib/eCarList/BLL/Auction/EclBidEngine.pm
badd +0 code/lib/eCarList/BLL/Auction.pm
badd +0 templates/admin/auction_widget/tradeops.tmpl
badd +1 ~/.vimrc
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/Widget.js
args code/lib/javascript/eCarList/App/Admin/Auction/OffersModal.js
edit code/lib/javascript/eCarList/App/Admin/Auction/OffersModal.js
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1251 - ((38 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1251
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1233 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1233
normal! 028l
tabedit code/lib/eCarList/BLL/Auction/EclBidEngine.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 123 - ((59 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
123
normal! 046l
tabedit templates/admin/auction_widget/tradeops.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 876 - ((37 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
876
normal! 028l
tabedit templates/admin/auction_offers_overlay.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((58 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
normal! 086l
tabedit code/lib/css/eCarList/admin/_auction_widget.scss
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 297 - ((44 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
297
