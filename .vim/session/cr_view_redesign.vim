...
set shortmess=aoO
badd +1 code/lib/eCarList/DM/Mongo/ConditionReport.pm
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +0 templates/admin/condition_report/wheels_tires.tmpl
badd +0 templates/admin/vehicle_tires.tmpl
badd +0 templates/admin/condition_report/mechanical.tmpl
badd +0 templates/admin/condition_report/misc.tmpl
badd +0 templates/admin/condition_report/damage.tmpl
badd +0 code/lib/eCarList/App/Interfaces/Web/Backend/QA.pm
badd +0 code/config/ecl.yml
argglobal
silent! argdel *
argadd code/lib/eCarList/DM/Mongo/ConditionReport.pm
set stal=2
...
silent! normal! zE
let s:l = 117 - ((46 * winheight(0) + 37) / 75)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1851 - ((13 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1851
normal! 05|
tabedit templates/admin/condition_report/wheels_tires.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 377 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
377
normal! 06|
tabedit templates/admin/condition_report/mechanical.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 144 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
144
