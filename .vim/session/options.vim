...
silent only
cd ~/repos/ecl~/repos/ecl~/repos/ecl_hf
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 code/lib/eCarList/BLL/CRUD/Option.pm
badd +0 assets/admin/js/eCarList_Site_Admin.js
badd +48 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +0 code/lib/eCarList/DM/KARD/AUTOGEN/StyleOptionalEquipment.pm
badd +0 code/lib/eCarList/BLL/CRUD/Dashboard/ExecutiveSummary.pm
badd +0 code/lib/eCarList/BLL/CRUD/Dashboard/RetailVsWholesale.pm
badd +238 code/lib/eCarList/App/Bot/OVE.pm
badd +159 code/lib/eCarList/BLL/CRUD/Dashboard/Operations.pm
badd +61 code/lib/eCarList/BLL/CRUD/Dealer.pm
badd +0 code/lib/eCarList/App/Interfaces/Web/Backend/Search.pm
badd +0 code/lib/eCarList/BLL/CRUD/User.pm
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/CRUD/Option.pm
set stal=2
edit code/lib/eCarList/BLL/CRUD/Option.pm
...
silent! normal! zE
let s:l = 226 - ((69 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
226
normal! 056|
tabedit code/lib/eCarList/DM/KARD/AUTOGEN/StyleOptionalEquipment.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2421 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2421
