...
set shortmess=aoO
badd +134 Product/BCM/ESP/podpurge.pl
badd +0 Product/Shared/ESP/Modules/ESP.pm
argglobal
silent! argdel *
argadd Product/BCM/ESP/podpurge.pl
set stal=2
edit Product/BCM/ESP/podpurge.pl
...
59
normal! 013|
tabedit Product/Shared/ESP/Modules/ESP.pm
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 883 - ((52 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
883
...
wincmd w
argglobal
edit Product/Shared/ESP/Modules/ESP.pm
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 994 - ((27 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
994
