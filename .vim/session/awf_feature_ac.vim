...
badd +0 code/lib/css/eCarList/admin/_appraisal_values.scss
badd +0 code/lib/javascript/eCarList/App/Admin/Appraisal/AppraisalWorkflowValues.js
badd +26 code/lib/eCarList/BLL/CRUD/AppraisalCentral.pm
badd +0 code/test/eCarListTest/BLL/CRUD/AppraisalCentral.pm
...
81
normal! 029|
tabedit code/lib/eCarList/App/Interfaces/Web/Backend/Features.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 925 - ((54 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
925
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4233 - ((40 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4233
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 118 - ((74 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1129 - ((15 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1129
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 420 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
420
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((27 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
