...
set incsearch
set modelines=0
set runtimepath=~/.vim,~/.vim/bundle/ag,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/tcomment_vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-perl,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set smarttab
...
set shortmess=aoO
badd +0 templates/admin/auction/tradedesk_live_event_summary.tmpl
badd +64 code/lib/eCarList/App/Interfaces/Web/Admin/Tradedesk.pm
badd +899 code/lib/eCarList/BLL/CRUD/UserEvent.pm
badd +1099 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
badd +0 code/lib/eCarList/DM/Mongo/UserEvent.pm
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/TradeDeskFacilitator.js
badd +1 ~/.vimrc
badd +29881 assets/admin/js/eCarList_Site_Admin.debug.js
badd +208 assets/admin/js/eCarList_Site_Admin.js
badd +107 code/lib/javascript/eCarList/App/Admin/Auction/TradeDeskParticipant.js
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +0 code/lib/eCarList/BLL/Auction.pm
args templates/admin/auction/tradedesk_live_event_summary.tmpl
edit templates/admin/auction/tradedesk_live_event_summary.tmpl
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 516 - ((35 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
516
normal! 024l
tabedit code/lib/javascript/eCarList/App/Admin/Auction/TradeDeskParticipant.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((43 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 897 - ((50 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
897
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 546 - ((46 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
546
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 470 - ((58 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
470
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1145 - ((55 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1145
