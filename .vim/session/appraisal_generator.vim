...
set shortmess=aoO
badd +1 code/script/setup/pa/fake_appraisals.pl
badd +1 code/script/run/appraisal_creator.pl
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +1 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +1 code/lib/eCarList/Bridge/RandomVIN.pm
badd +138 code/lib/eCarList/Util/Deferrer.pm
badd +1 code/lib/eCarList/DM/KARD/Trade.pm
badd +553 code/lib/eCarList/DM/KARD/_Object.pm
badd +0 code/lib/eCarList/DM/OLAP/Translator/KARD/_Translator.pm
args code/script/setup/pa/fake_appraisals.pl
edit code/script/setup/pa/fake_appraisals.pl
...
silent! normal! zE
let s:l = 347 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
347
normal! 0
tabedit code/script/run/appraisal_creator.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 107 - ((53 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2886 - ((64 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2886
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 241 - ((70 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
241
normal! 023l
tabedit code/lib/eCarList/DM/KARD/Trade.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 454 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
454
normal! 011l
tabedit code/lib/eCarList/DM/OLAP/Translator/KARD/_Translator.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 398 - ((44 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
398
normal! 041l
tabedit code/lib/eCarList/Util/Deferrer.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
1
normal! 08l
tabedit code/lib/eCarList/Bridge/RandomVIN.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((51 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
