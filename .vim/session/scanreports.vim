...
set isfname=@,48-57,/,.,-,_,+,,,#,$,%,~,=,:
set laststatus=2
set runtimepath=~/.vim,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/lightline.vim/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/vim-startify/,~/.vim/plugged/vim-perl/,~/.vim/plugged/ctrlp.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-perl/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
set smartindent
...
set shortmess=aoO
badd +397 Product/MCU/CGI/scanreport.cgi
badd +1 Product/Shared/ESP/Modules/Scans.pm
badd +856 Product/Shared/ESP/Modules/ESPweb.pm
badd +194 Product/MCU/ESP/getscanreport.pl
badd +1 Product/MCU/CGI/scanignoreedit.cgi
badd +102 Product/MCU/ESP/getscanignored.pl
badd +5 Product/CVS/Entries
badd +1 Product/MCU/ESP/setscanignore.pl
badd +1 Product/MCU/ESP/scancheck.pl
badd +0 ~/.bashrc
argglobal
silent! argdel *
argadd Product/MCU/CGI/scanreport.cgi
set stal=2
edit Product/MCU/CGI/scanreport.cgi
...
setlocal omnifunc=
setlocal path=.,/usr/include,,,/usr/local/lib64/perl5,/usr/local/share/perl5,/usr/lib64/perl5/vendor_perl,/usr/share/perl5/vendor_perl,/usr/lib64/perl5,/usr/share/perl5,,
...
silent! normal! zE
let s:l = 209 - ((0 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
normal! 036|
tabedit Product/MCU/ESP/getscanreport.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 220 - ((52 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
normal! 014|
tabedit Product/Shared/ESP/Modules/ESPweb.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1456 - ((0 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1456
normal! 010|
tabedit Product/MCU/CGI/scanignoreedit.cgi
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 54 - ((52 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
normal! 0
tabedit Product/MCU/ESP/setscanignore.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 204 - ((50 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
normal! 0
tabedit Product/MCU/ESP/scancheck.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 270 - ((52 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
270
