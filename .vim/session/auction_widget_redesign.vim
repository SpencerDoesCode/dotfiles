...
set incsearch
set modelines=0
set runtimepath=~/.vim,~/.vim/bundle/TagHighlight,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-perl,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set smarttab
...
set shortmess=aoO
badd +497 templates/admin/search/search_vehicle_detail.tmpl
badd +1 templates/admin/auction_widget/tradeops.tmpl
badd +1 templates/admin/search/search_results.tmpl
badd +1 code/lib/javascript/eCarList/App/Admin/Auction/Widget.js
badd +1 templates/admin/auction_widget/common/views_offers_watchlist.tmpl
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
badd +1 code/lib/javascript/eCarList/App/Admin/SearchPage.js
...
args templates/admin/search/search_vehicle_detail.tmpl
edit templates/admin/auction_widget/tradeops.tmpl
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 262 - ((58 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
262
normal! 09l
tabedit templates/admin/auction_widget/common/views_offers_watchlist.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((15 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1559 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1559
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1815 - ((22 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1815
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 609 - ((57 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
609
