...
badd +141 templates/admin/inventory/common_current.tmpl
badd +13515 assets/admin/js/eCarList_Site_Specials.debug.js
...
silent! normal! zE
let s:l = 1579 - ((41 * winheight(0) + 41) / 83)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 222 - ((82 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
222
