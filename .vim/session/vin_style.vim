...
argglobal
silent! argdel *
argadd code/lib/eCarList/BLL/CRUD/VinStyle.pm
edit code/lib/eCarList/BLL/CRUD/VinStyle.pm
...
silent! normal! zE
let s:l = 740 - ((69 * winheight(0) + 37) / 75)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 731 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
731
