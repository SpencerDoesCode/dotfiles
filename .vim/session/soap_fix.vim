...
set runtimepath=~/.vim,~/.vim/bundle/ag,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/fonts,~/.vim/bundle/lightline.vim,~/.vim/bundle/Spacegray.vim,~/.vim/bundle/supertab,~/.vim/bundle/tcomment_vim,~/.vim/bundle/vim-colorschemes,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-perl,~/.vim/bundle/vim-startify,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim74,/usr/local/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
set smartindent
...
set shortmess=aoO
badd +457 code/lib/eCarList/BLL/CRUD/DealerGroup.pm
badd +1 ~/.vimrc
badd +1 code/script/console
badd +1 code/lib/eCarList/App/Interfaces/Console.pm
badd +115 code/lib/eCarList/DM/KARD/Trade.pm
badd +1 code/test/Integration/App/Interfaces/Soap/Soap_AAX_Compat_1_0.pm
badd +1 code/lib/eCarList/Bridge/Testbench/AAXCompatSOAP.pm
badd +1 code/lib/eCarList/App/Interfaces/Soap/Soap_AAX_Compat_1_0.pm
badd +1 code/config/ecl.yml
badd +1 code/test/test.pl
badd +1 code/test/_ECLTestExec.pm
badd +1 code/lib/eCarList/Util/Metric/Publisher/Easy.pm
badd +0 code/lib/eCarList/App/Server/Soap/Handler/WebService.pm
argglobal
silent! argdel *
argadd code/test/Integration/App/Interfaces/Soap/Soap_AAX_Compat_1_0.pm
set stal=2
edit code/test/Integration/App/Interfaces/Soap/Soap_AAX_Compat_1_0.pm
...
silent! normal! zE
let s:l = 129 - ((45 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
129
normal! 05|
tabedit code/lib/eCarList/App/Interfaces/Soap/Soap_AAX_Compat_1_0.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 372 - ((42 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
372
normal! 04|
tabedit code/lib/eCarList/Bridge/Testbench/AAXCompatSOAP.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 163 - ((42 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
163
normal! 05|
tabedit code/lib/eCarList/App/Server/Soap/Handler/WebService.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 122 - ((40 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
122
normal! 05|
tabedit code/config/ecl.yml
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1795 - ((55 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1795
normal! 0
tabedit code/test/test.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 129 - ((41 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
129
normal! 036|
tabedit code/test/_ECLTestExec.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
143
normal! 070|
tabedit code/lib/eCarList/Util/Metric/Publisher/Easy.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((10 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
