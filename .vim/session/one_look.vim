...
set shortmess=aoO
badd +0 templates/admin/vehicle_edit.tmpl
badd +0 templates/admin/inventory/common_one_look.tmpl
badd +527 code/lib/css/eCarList/admin/_inventory_common.scss
badd +0 code/lib/javascript/eCarList/App/Admin/Inventory/OneLookPage.js
...
silent! normal! zE
let s:l = 1529 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1529
normal! 040l
tabedit templates/admin/inventory/common_one_look.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((2 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
normal! 0
tabedit code/lib/javascript/eCarList/App/Admin/Inventory/OneLookPage.js
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((0 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1536 - ((10 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1536
normal! 01l
tabedit code/lib/css/eCarList/admin/_inventory_common.scss
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 586 - ((69 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
586
