...
set shortmess=aoO
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Dealer.pm
badd +0 templates/admin/dealer_edit.tmpl
badd +0 code/lib/eCarList/DM/KARD/User.pm
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 1414 - ((74 * winheight(0) + 37) / 75)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 820 - ((62 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
820
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 186 - ((41 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
