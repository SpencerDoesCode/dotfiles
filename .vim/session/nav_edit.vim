...
badd +1191 code/lib/eCarList/BLL/Auction.pm
badd +1724 code/config/ecl.yml
badd +0 code/lib/javascript/eCarList/App/Admin/Auction/OffersModal.js
badd +0 templates/admin/nav_main_tabs.tmpl
badd +0 templates/oadmin/nav_main_tabs.tmpl
args templates/admin/auction_offers_overlay.tmpl
edit templates/admin/auction_offers_overlay.tmpl
...
silent! normal! zE
let s:l = 57 - ((56 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 286 - ((38 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
286
normal! 0
tabedit code/lib/javascript/eCarList/App/Admin/Auction/OffersModal.js
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((0 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
exe '1resize ' . ((&lines * 61 + 37) / 75)
exe '2resize ' . ((&lines * 10 + 37) / 75)
tabedit templates/admin/nav_main_tabs.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 310 - ((56 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
310
normal! 0
tabedit templates/oadmin/nav_main_tabs.tmpl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 253 - ((0 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
253
