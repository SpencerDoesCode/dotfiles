...
set shortmess=aoO
badd +0 code/bots/chromebot/script/load_chrome_1.pl
badd +0 code/lib/eCarList/App/Interfaces/Web/Admin/Vehicle.pm
badd +0 code/lib/eCarList/BLL/CRUD/VinStyle.pm
args code/bots/chromebot/script/load_chrome_1.pl
edit code/bots/chromebot/script/load_chrome_1.pl
...
silent! normal! zE
let s:l = 241 - ((0 * winheight(0) + 42) / 84)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 6297 - ((57 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
6297
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 244 - ((0 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
244
