...
silent only
cd ~/repos/ecl~/repos/ecl~/repos/ecl_dev
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +275 code/lib/eCarList/App/Interfaces/Web/Backend/Search.pm
badd +1 code/lib/eCarList/BLL/CRUD/Dealer.pm
badd +1 code/lib/javascript/eCarList/UI/AutoComplete.js
badd +1 code/lib/eCarList/DM/KARD/User.pm
badd +1 code/lib/eCarList/BLL/CRUD/Circle.pm
badd +1 code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
badd +1 code/lib/eCarList/DM/KARD/Dealer.pm
badd +1 templates/notification/auction/send_link_subject.tmpl
badd +0 templates/notification/auction/send_link_web.tmpl
badd +0 code/lib/eCarList/BLL/CRUD/User.pm
args code/lib/eCarList/App/Interfaces/Web/Backend/Search.pm
edit code/lib/eCarList/App/Interfaces/Web/Admin/Search.pm
...
silent! normal! zE
let s:l = 328 - ((46 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 184 - ((47 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
184
normal! 0
tabedit templates/notification/auction/send_link_subject.tmpl
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 028l
tabedit templates/notification/auction/send_link_web.tmpl
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 690 - ((59 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
690
normal! 0
tabedit code/lib/eCarList/DM/KARD/User.pm
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 584 - ((36 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
584
normal! 0
tabedit code/lib/javascript/eCarList/UI/AutoComplete.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((35 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
normal! 06l
tabedit code/lib/eCarList/BLL/CRUD/Dealer.pm
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
