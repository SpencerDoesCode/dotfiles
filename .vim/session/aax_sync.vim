...
set shortmess=aoO
badd +715 code/lib/eCarList/BLL/Sync/AAXData.pm
badd +1 code/lib/eCarList/BLL/CRUD/Trade.pm
badd +1 code/lib/eCarList/BLL/BREAD/Trade.pm
badd +115 code/bots/syncbot/script/sync.pl
badd +1596 code/config/ecl.yml
badd +1 code/lib/eCarList/App/Bot/TradeTrackerImport.pm
badd +360 code/lib/eCarList/BLL/Config/Locale.pm
argglobal
silent! argdel *
set stal=2
edit code/lib/eCarList/BLL/Sync/AAXData.pm
...
exe 'vert 1resize ' . ((&columns * 135 + 102) / 204)
...
silent! normal! zE
let s:l = 826 - ((12 * winheight(0) + 28) / 56)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 248 - ((26 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
248
...
exe 'vert 1resize ' . ((&columns * 135 + 102) / 204)
exe 'vert 2resize ' . ((&columns * 68 + 102) / 204)
tabedit code/bots/syncbot/script/sync.pl
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 75 - ((0 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
normal! 0
2wincmd w
tabedit code/lib/eCarList/BLL/BREAD/Trade.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 99 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
normal! 0
2wincmd w
tabedit code/lib/eCarList/App/Bot/TradeTrackerImport.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 747 - ((36 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
747
