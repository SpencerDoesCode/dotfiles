...
silent! normal! zE
let s:l = 81 - ((69 * winheight(0) + 38) / 76)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2634 - ((31 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2634
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 484 - ((39 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
484
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 89 - ((73 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((31 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
