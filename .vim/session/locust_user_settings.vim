...
set shortmess=aoO
badd +61 inventory.locust/inventory_pa/pa_test/user/user_settings.py
badd +0 inventory.locust/inventory_pa/pa_test/user/user_settings.yml
badd +25 inventory.locust/inventory_pa/lib/core/vehicle_creator.py
badd +124 ecl/templates/admin/user_settings.tmpl
badd +0 ecl/code/lib/eCarList/App/Interfaces/Web/Admin/UserSettings.pm
badd +0 inventory.locust/inventory_pa/pa_test/inventory/edit.py
argglobal
silent! argdel *
argadd inventory.locust/inventory_pa/pa_test/user/user_settings.py
set stal=2
edit inventory.locust/inventory_pa/pa_test/user/user_settings.py
...
silent! normal! zE
let s:l = 28 - ((21 * winheight(0) + 41) / 83)
...
wincmd w
argglobal
edit inventory.locust/inventory_pa/pa_test/user/user_settings.yml
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((42 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
exe 'vert 1resize ' . ((&columns * 135 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 136 + 136) / 272)
tabedit ecl/code/lib/eCarList/App/Interfaces/Web/Admin/UserSettings.pm
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((50 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
normal! 013|
tabedit inventory.locust/inventory_pa/pa_test/inventory/edit.py
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
