...
set guicursor=n-v-c:block-Cursor,i-ci:ver15-iCursor
set helplang=en
set hlsearch
set ignorecase
set incsearch
...
silent only
cd ~/repos/ecl~/repos/ecl~/repos/ecl_3_0
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 code/lib/javascript/eCarList/App/Admin/Auction/Widget.js
badd +254 code/lib/eCarList/App/Interfaces/Web/Admin/Auction.pm
badd +109 code/lib/eCarList/App/Interfaces/Web/Admin/Appraisal.pm
badd +1 code/lib/eCarList/BLL/CRUD/Market.pm
badd +42 ~/.vimrc
badd +1 code/lib/eCarList/BLL/Auction.pm
silent! argdel *
edit code/lib/javascript/eCarList/App/Admin/Auction/Widget.js
...
silent! normal! zE
let s:l = 836 - ((56 * winheight(0) + 36) / 73)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2506 - ((66 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2506
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2428 - ((63 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2428
